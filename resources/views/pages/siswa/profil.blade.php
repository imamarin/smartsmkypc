...
@section('content')
            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('siswa.profil') }}">Profil Siswa</a></li>
                    </ol>
                </div>
    ...
    <!-- end page title -->
    <form action="{{ route('profil-siswa.update', Crypt::encrypt($siswa->user->id)) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-12">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="number" name="nisn"
                                            value="{{ $siswa->nisn_dapodik }}" required readonly>
                                    </div>
                                </div><!-- end row -->
                                <div class="mb-3 row">
