                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <div class="row mb-3 mb-lg-0 row">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="walisiswa">
                                    </div>
                                </div><!-- end row -->
                                <div class="mb-3 row">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="number" name="no_hp_wali">
                                    </div>
                                </div>
                            </div><!-- end col -->
                            <div class="col-xl-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="alamat_wali" class="form-control" cols="30" rows="4"></textarea>
                                    </div>
                                </div><!-- end row -->
                            </div>
                        </div><!-- end row -->
