        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center" style="background-color: rgb(31, 177, 188)">
                    <div class="col">
                        <h4 class="card-title text-white">Daftar Aktivasi Raport</h4>
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-end">
                            ...
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addSubjectModal">Tambah Data</button>
                        </div>
                    </div>
                    @endif
                </div><!-- end card header -->
