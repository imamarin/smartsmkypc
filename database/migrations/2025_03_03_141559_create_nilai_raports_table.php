...
return new class extends Migration
{
    ...
    {
        Schema::create('rpt_nilai_raports', function (Blueprint $table) {
            $table->id();
            $table->string('nip', 20);
            ...
            $table->integer('kkm');
            $table->integer('bobot_pengetahuan');
            $table->integer('bobot_keterampilan');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('rpt_nilai_raports');
    }
};
